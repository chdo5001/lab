...
class extent_client {
 ...
 public:
  ...
  virtual extent_protocol::status getAttr(extent_protocol::extentid_t id, extent_protocol::attr &a);
  virtual void flush(extent_protocol::extentid_t id);
  virtual extent_protocol::status remove(extent_protocol::extentid_t id, const char* name);
  ...
  virtual extent_protocol::status createFile(extent_protocol::extentid_t parent, const char *name, mode_t mode);
